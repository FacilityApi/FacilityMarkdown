...
| --- | --- | --- |
| [getApiInfo](getApiInfo.md) | `GET /` | Gets API information. |
...
| [mirrorFields](mirrorFields.md) | `POST /mirrorFields` |  |
| [checkQuery](checkQuery.md) | `GET /checkQuery` |  |
| [checkPath](checkPath.md) | `GET /mirror/{string}/{boolean}/{double}/{int32}/{int64}/{decimal}/{enum}` |  |
| [mirrorHeaders](mirrorHeaders.md) | `GET /mirrorHeaders` |  |
| [mixed](mixed.md) | `POST /mixed/{path}` |  |
...
| [AnyMap](AnyMap.md) |  |
| [AnyResult](AnyResult.md) |  |

| enum | description |
| --- | --- |
| [Answer](Answer.md) | One of three answers. |

| errors | description |
| --- | --- |
| [ApiErrors](ApiErrors.md) | Custom errors. |
