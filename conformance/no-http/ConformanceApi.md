...
| method | description |
| --- | --- |
| [getApiInfo](ConformanceApi/getApiInfo.md) | Gets API information. |
| [getWidgets](ConformanceApi/getWidgets.md) | Gets widgets. |
| [createWidget](ConformanceApi/createWidget.md) | Creates a new widget. |
| [getWidget](ConformanceApi/getWidget.md) | Gets the specified widget. |
| [deleteWidget](ConformanceApi/deleteWidget.md) | Deletes the specified widget. |
| [getWidgetBatch](ConformanceApi/getWidgetBatch.md) | Gets the specified widgets. |
| [mirrorFields](ConformanceApi/mirrorFields.md) |  |
| [checkQuery](ConformanceApi/checkQuery.md) |  |
