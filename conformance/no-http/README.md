...
| method | description |
| --- | --- |
| [getApiInfo](getApiInfo.md) | Gets API information. |
| [getWidgets](getWidgets.md) | Gets widgets. |
| [createWidget](createWidget.md) | Creates a new widget. |
| [getWidget](getWidget.md) | Gets the specified widget. |
| [deleteWidget](deleteWidget.md) | Deletes the specified widget. |
| [getWidgetBatch](getWidgetBatch.md) | Gets the specified widgets. |
| [mirrorFields](mirrorFields.md) |  |
| [checkQuery](checkQuery.md) |  |
| [checkPath](checkPath.md) |  |
| [mirrorHeaders](mirrorHeaders.md) |  |
| [mixed](mixed.md) |  |
